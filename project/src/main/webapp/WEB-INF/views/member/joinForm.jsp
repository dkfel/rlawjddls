								...
								<div class="inner">
												<div class="container">
																<div class="jumbotron" style="padding-top: 20px">
																				...
																				<div class="content">
																								<header>
																												<h2 style="text-align: center;" class="joinFrmHeaderText">회원가입</h2>
																								</header>
																				</div>
																								...
																								<div class="form-group">
																												...
																												<input type="button" id="email_btn" name="email_btn" value="중복체크"><div class="check_font" id="email_check"></div><br>
																								</div>
																								<div class="form-group">
																								...
																								<div class="form-group">
																												<span class="joinFrmText">상세주소:</span><br /> <input type="text" id="address" name="address" value="${param.address}" class="form-control" maxlength="20" placeholder="주소"> <input type="button" id="address_btn" onclick="execDaumPostcode()" value="주소 검색"><br>
